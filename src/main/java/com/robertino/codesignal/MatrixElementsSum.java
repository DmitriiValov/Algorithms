...
A 2-dimensional array of integers representing the cost of each room in the building. A value of 0 indicates that
the room is haunted.
...
public class MatrixElementsSum {
    ...
    public static void main(String[] args) {
        int[][] buildings = { {0, 1, 1, 2}, {0, 5, 0, 0}, {2, 0, 3, 3} };
        int result = new MatrixElementsSum().matrixElementsSum(buildings);
